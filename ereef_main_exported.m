classdef ereef_main_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function getDataSourceInfo(app)
            ...
            try
                timeVar = find(matches({ginfo.Dimensions.Name}, 'time'));
                lonVar = find(matches({ginfo.Dimensions.Name}, 'i'));
                latVar = find(matches({ginfo.Dimensions.Name}, 'j'));
                zVar = find(matches({ginfo.Dimensions.Name}, 'k'));
            catch
        ...
        function plotTempCurrentMap(app)
            ...
            try
                g = geoshow(app.MainPlot, 'reefmap_rough.tif');
                ...
                err_dlg = errordlg('Map file missing: reefmap_rough.tif and world file .tfw','ERROR');
                waitfor(err_dlg);
                app.MainPlot.XLim = [142 157];
                app.MainPlot.YLim = [-29 -7];
            end
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            % hide control panel and plot frame until everything is loaded
            h = app.UIFigure;
            %app.ControlPanel.Visible = 'off'
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ControlPanel.Position = [15 349 251 356];
            ...
            app.SelectLocationforTimeElevationTemperatureMapButton.Position = [13 105 214 38];
            ...
            app.ShowCurrentsCheckBox.Position = [17 167 101 22];
            ...
            app.ScaleTemperatureColourBarCheckBox.Position = [15 218 183 23];
            ...
            app.ElevationmDropDownLabel.Position = [12 287 76 22];
            ...
            app.ElevationmDropDown.Position = [103 287 100 22];
            ...
            app.TimeDropDownLabel.Position = [16 250 31 22];
            ...
            app.TimeDropDown.Position = [62 250 178 22];
            ...
            app.DataSourceURLEditFieldLabel.Position = [12 323 99 22];
            ...
            app.DataSourceURLEditField.Position = [126 323 113 21];
            ...
            app.AutoScaleCurrentsCheckBox.Position = [122 167 124 22];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = ereef_main_exported
